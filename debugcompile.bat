...
REM gl3w
cl /Fo:bin\gl3w.obj     /c lib\gl3w.c   /nologo -EHsc -Zi /MD /Iinclude

REM main
cl /Fo:bin\defines.obj  /c src\defines.cpp  /nologo -EHsc -DNDEBUG /MD /Isrc
cl /Fo:bin\glak.obj     /c src\glak.cpp     /nologo -EHsc -Zi /MD /Isrc /Iinclude /IR:\dear-imgui /Iinclude/SDL
cl /Fo:bin\main.obj     /c src\main.cpp     /nologo -EHsc -Zi /MD /Isrc /Iinclude /IR:\dear-imgui /Iinclude/SDL

REM link
link /DEBUG /SUBSYSTEM:CONSOLE /nologo /out:out\app.exe ^
