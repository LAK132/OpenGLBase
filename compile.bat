...
cl /Fo:bin\glak.obj     /c src\glak.cpp     /nologo -EHsc -DNDEBUG /MD /Isrc /Iinclude /IR:\dear-imgui
cl /Fo:bin\main.obj     /c src\main.cpp     /nologo -EHsc -DNDEBUG /MD /Isrc /Iinclude /IR:\dear-imgui
